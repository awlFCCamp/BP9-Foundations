...
module.exports = {
  getAllClients: (req, res) => {
    sequelize
      .query(
        `select * from cc_clients as c inner join cc_users as u on c.user_id=u.user_id;`
      )
  ...
  getPastAppointments: (req, res) => {
    sequelize
      .query(
        ...
        inner join cc_emp_appts as ea on a.appt_id=ea.appt_id 
        inner join cc_employees as e on e.emp_id=ea.emp_id 
        inner join cc_users u on e.user_id=u.user_id
