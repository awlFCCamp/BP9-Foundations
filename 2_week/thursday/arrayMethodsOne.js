...
// CODE HERE
const evenNumbers = mixedNumbers.filter((ele) => ele % 2 === 0);
...
// CODE HERE
const postTaxPrices = prices.map((price) => (price * (1 + 0.07)).toFixed(2));
...
// CODE HERE
const totalPopulation = populations.reduce((total, curr) => total + curr, 0);
